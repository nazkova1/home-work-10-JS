// 1.  Напишіть функцию arrCopy(arr), яка копією масив не змінюючи оригінал arr.
...
// const arr2 = arrToString([10, 20, 3333]);
// console.log(arr1);
// console.log(arr2);
...
// const getLength = arr => arr.map(string => string.length);
// const arr2 = getLength(["Ivan", "Pavlo", "Ira"]);
// const arr3 = getLength(["Vitaliy", "Nazariy"]);
// console.log(arr2);
// console.log(arr3);


// 4.Напишіть функцію removeDuplicates(arr), яка приймає масив arr з стрічок і повертає новий масив де виключені 
// елементи, що повторюються з масиву arr(ігнорувати чутливість до регістру):
